...
KEYS_TO_EXIT_CODES = {
    ...
    KEY_SHIFT_F12: (EXIT_CODE_SHIFT + EXIT_CODE_F12),
    KEY_ALT_F12: (EXIT_CODE_ALT + EXIT_CODE_F12),
    KEY_ALT_SHIFT_F12: (EXIT_CODE_ALT + EXIT_CODE_SHIFT + EXIT_CODE_F12),
    KEY_CTRL_F12: (EXIT_CODE_CTRL + EXIT_CODE_F12),
    KEY_CTRL_SHIFT_F12: (EXIT_CODE_CTRL + EXIT_CODE_SHIFT + EXIT_CODE_F12),
    KEY_CTRL_ALT_SHIFT_F12: (EXIT_CODE_CTRL + EXIT_CODE_ALT + EXIT_CODE_SHIFT + EXIT_CODE_F12),
}
