...
from datatools.intent.targets import set_clipboard, html_to_browser
...
def handle_json_lines(post_body: bytes, the_title: str, collapsed_columns: dict[str, bool] = None):
    ...
    match choose(
        ...
        case 2:
            set_clipboard(str(page_node_auto(lines, title_str=the_title)))
        case 3:
        ...
        case 4:
            set_clipboard(str(page_node_basic_auto(lines, title_str=the_title)))
        case 5:
            set_clipboard(str(md_table_node(lines)))
