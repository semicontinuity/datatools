...
class OldToolkit:
    ...
    def node(self, j, parent, in_array_of_nestable_obj: bool):
        ...
        if type(j) is dict:
            return self._dict_node(j, parent, in_array_of_nestable_obj)
        elif type(j) is list:
            return self._list_node(j, parent, in_array_of_nestable_obj)
        else:
            return j
    ...
    def _list_node(self, j, parent, in_array_of_nestable_obj: bool):
        ...
        if descriptor is not None:
            ...
            return MatrixNode(j, parent, width) if width is not None else self.list_node(j, parent,
                                                                                         in_array_of_nestable_obj)
